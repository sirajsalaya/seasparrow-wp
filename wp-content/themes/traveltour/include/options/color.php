		...
		'options' => array(
			...
			'single-blog' => array(
				...
				'options' => array(		
					...
					'single-blog-tag-text' => array(
						'title' => esc_html__('Single Blog Tag Hover Background', 'traveltour'),
						'type' => 'colorpicker',
						'default' => '#000000',
						'selector' => 'body .traveltour-single-tags a{ color: #gdlr#; }'
					),
					'single-blog-tag-hover-background' => array(
						'title' => esc_html__('Single Blog Tag Hover Background', 'traveltour'),
						'type' => 'colorpicker',
						'default' => '#ffb156',
						'selector' => 'body .traveltour-single-tags a:hover{ background-color: #gdlr#; border-color: #gdlr#; color: #fff; }'
					),
				...
				'options' => array(
					...
					'accordion-title-background-color' => array(
						...
						'selector' => '.gdlr-core-accordion-style-background-title .gdlr-core-accordion-item-title, ' . 
							...
							'.gdlr-core-accordion-style-shadow-background .gdlr-core-accordion-item-tab.gdlr-core-active .gdlr-core-accordion-item-content-wrapper{ background-color: #gdlr#; }'
					),				
