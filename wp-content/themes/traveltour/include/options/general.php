			...
			'layout' => array(
				...
				'options' => array(
					...
					'sidebar-heading-tag' => array(
						'title' => esc_html__('Sidebar Heading Tag', 'traveltour'),
						'type' => 'combobox',
						'options' => array(
			...
			'blog-style' => array(
				...
				'options' => array(
					'single-blog-style' => array(
						'title' => esc_html__('Single Blog Style', 'traveltour'),
						'type' => 'combobox',
						'options' => array(
							'' => esc_html__('Default', 'traveltour'),
							'style-2' => esc_html__('Style 2', 'traveltour')
						),
					),
					'blog-quote-style' => array(
						'title' => esc_html__('Blog Quote Style', 'traveltour'),
						'type' => 'combobox',
						'options' => array(
							'' => esc_html__('Default', 'traveltour'),
							'style-2' => esc_html__('Style 2', 'traveltour')
